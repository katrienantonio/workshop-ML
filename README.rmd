...
On **Day 3** you will be working with the R interface to `keras`. We recommend the installation instructions on <https://keras.rstudio.com/>. 
...
If the above instructions do **not** work, you can **alternatively** proceed as follows
...
* install Anaconda. This straightforward after launching the installer, but (in case you are in doubt) some instructions are at <https://docs.anaconda.com/anaconda/install/windows/>
...
<p align="justify">[Katrien Antonio](https://katrienantonio.github.io/) is professor in insurance data science at KU Leuven and associate professor at University of Amsterdam. She teaches courses on data science for insurance, life and non-life insurance mathematics and loss models. Research-wise Katrien puts focus on pricing, reserving and fraud analytics, as well as mortality dynamics. Katrien will teach Day 1 of thw workshop, and serve as TA on Day 2 and 3.</p>
