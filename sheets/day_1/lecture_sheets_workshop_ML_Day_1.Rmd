...
library(knitr)
path <- "C:/Users/u0043788/Dropbox/NN Machine learning training/lecture sheets Katrien/course material NN ML"
setwd(path)
file.exists("lecture_sheets_workshop_ML_Day_1.Rmd")
purl("lecture_sheets_workshop_ML_Day_1.Rmd")
```
