...
.font200[`r fa(name = 'bullhorn', fill = KULbg)`] Note that .KULbginline[tuning] of the .hi-pink[super learner] is adviced!
...
.right-column[
.KULbginline[That's all folks] for .hi-pink[today]. Ready to shutdown.
```{r,eval=FALSE}
h2o.shutdown()
```
